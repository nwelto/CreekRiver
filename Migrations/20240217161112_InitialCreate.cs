        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://example.com/campgrounds/red-fox.jpg", "Red Fox Den" },
                    { 3, 1, "https://example.com/campgrounds/whispering-pines.jpg", "Whispering Pines" },
                    { 4, 3, "https://example.com/campgrounds/hidden-creek.jpg", "Hidden Creek" },
                    { 5, 4, "https://example.com/campgrounds/eagles-nest.jpg", "Eagle's Nest" }
                });
